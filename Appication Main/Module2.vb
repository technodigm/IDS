...
'    Private HookDelegate As HookCallback
...
'        End If
'    End Sub
'    Public Sub ReleaseControls()
'        'Remove the hook
'        UnhookWindowsHookEx(HookId)
'    End Sub
'    <DllImport("user32.dll", CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.StdCall)> _
'    Private Function CallNextHookEx(ByVal idHook As Integer, ByVal nCode As Integer, ByVal wParam As IntPtr, ByVal lParam As IntPtr) As Integer
'    End Function
'    <DllImport("user32.dll", CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.StdCall, SetLastError:=True)> _
'    Private Function SetWindowsHookEx(ByVal idHook As Integer, ByVal HookProc As HookCallback, ByVal hInstance As IntPtr, ByVal wParam As Integer) As Integer
'    End Function
'    <DllImport("user32.dll", CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.StdCall, SetLastError:=True)> _
'    Private Function UnhookWindowsHookEx(ByVal idHook As Integer) As Integer
'    End Function
