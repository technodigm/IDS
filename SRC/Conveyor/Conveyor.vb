...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.AxMSComm1.Location = New System.Drawing.Point(464, 16)
...
#End Region
    ...
    Public wdtPosition As Double = 0
    Public currentError As String = ""
    Public mvToWidth As Double = -1

    Public Property MoveToWidth() As Double Implements IPLC.MoveToWidth
        Get
            Return mvToWidth
        End Get
        ...
        End Set
    End Property
    Public Property WidthPosition() As Double Implements IPLC.WidthPosition
        Get
            Return wdtPosition
        End Get
        Set(ByVal Value As Double)
        ...
        End Set
    End Property
    Public Property ConveyorError() As String Implements IPLC.ConveyorError
        Get
            Return currentError
        End Get
    ...
    Public Sub ActivePositionTimer(ByVal start As Boolean) Implements IPLC.ActivePositionTimer
        If start Then
            PositionTimer.Start()
        Else
            PositionTimer.Stop()
    ...
    End Sub
    Public Sub ShowForm() Implements IPLC.ShowForm
        Me.Show()
    End Sub
    Public Sub HideForm() Implements IPLC.HideForm
        Me.Hide()
    End Sub
    Public Function GetError() As String Implements IPLC.GetError
        If currentError = "Width" Then
            Return "Width Adjustment Failed"
        ElseIf currentError = "Lifter 1 Blocked" Then
            Return "Lifter 1 Blocked"
        ElseIf currentError = "Lifter 2 Blocked" Then
            Return "Lifter 2 Blocked"
        ElseIf currentError = "Lifter 3 Blocked" Then
            Return "Lifter 3 Blocked"
        ElseIf currentError = "S1 to S2 Jam" Then
            Return "Retrieve Timeout"
        ElseIf currentError = "Up-Stream to S1 Jam" Then
            Return "Stage 1 Travel Timeout"
        ElseIf currentError = "S2 to S3 Jam" Then
            Return "Release Travel Timeout"
        ElseIf currentError = "S3 to Down-Stream Jam" Then
            Return "Stage 3 Travel Timeout"
        ElseIf currentError = "Alignment Wrong" Then
            Return "Board Not Aligned"
        ElseIf currentError = "Others" Then
    ...
    Public Function ReportWidthAdjustFailure() As String Implements IPLC.ReportWidthAdjustFailure
    ...
    Public Function OpenPort() As Boolean Implements IPLC.OpenPort
    ...
    Public Function ClosePort() As Boolean Implements IPLC.ClosePort
    ...
    Public Function Command(ByVal cmd As String) As Boolean Implements IPLC.Command
    ...
    Public Sub Reset() Implements IPLC.Reset
        Command("Reset Up-S1")
        Command("Reset S1-S2")
        Command("Reset S2-S3")
    ...
    Public Function SetCommand(ByVal command As String, ByVal value As Decimal) As Boolean Implements IPLC.SetCommand
    ...
    Public Function MoveTo(ByVal width As Double) As Boolean Implements IPLC.MoveTo
